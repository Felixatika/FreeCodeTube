...
class Video extends \yii\db\ActiveRecord
{
   ...
   */
    ...
    public function save($runValidation = true, $attributeNames = null)
    {
        ...
        if($isInsert){
            $videoPath = Yii::getAlias( '@frontend/web/storage/videos/' .$this->video_id . '.mkv');
        ...
        {
            return Yii::$app->params['frontendUrl'] .'/storage/videos/' .$this->video_id . '.mkv';
        }
